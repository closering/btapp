...
public class StatusExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		if (convertView != null) {
			...
			viewHolder.twoStatusLocation = (TextView) convertView.findViewById(R.id.two_status_location);
		...
		viewHolder.twoStatusLocation.setText(entity.getStatusLocation());
	...
	private class ChildViewHolder {
		...
		public TextView twoStatusLocation;
	}
