...
public class WGSTOGCJ02 {
	...
	private static double a = 6378245.0D;//WGS长轴半径				  
	private static double ee = 0.00669342162296594323D;//WGS偏心率的平方
	...
	public Map<String, Double> transform(double lon, double lat) {
		...
		//System.out.println("lon1:"+mgLon);
		//System.out.println("lat1:"+mgLat);
		return localHashMap;
	}
